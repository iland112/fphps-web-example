...
- [x] `docs` 디렉터리 생성 및 사용자 매뉴얼, API 문서 등 산출물 정리
- [x] JNA 인터페이스 관련 로직 설명 주석 추가
- [x] Bouncy Castle을 사용한 전자여권 인증(BAC, PACE, AA 등) 과정 상세 설명 추가
- [x] 로컬 라이브러리(`fphps-1.0.0.jar`)를 Nexus 와 같은 사설 Maven 저장소에 배포하여 관리하는 방식으로 전환 검토
